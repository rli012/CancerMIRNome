  ...
  dashboardBody(fluidRow(
    ...
    box(
      ...
      column(12,
             ...
             h5(strong("The role of microRNAs (miRNAs) in human cancer")),
             # tags$p("miRNAs are a class of small endogenous non-coding RNAs of 
             ...
             # function as oncogenes or tumor suppressors. Mounting evidence has 
      ...
      box(
        ...
        column(12,
             ...
             # detection.", 
             tags$p("Circulating miRNAs represent the miRNAs that are secreted into extracellular body 
                    fluids, where they are incorporated in extracellular vesicles (EVs), 
                    such as shed microvesicles (sMVs) and exosomes, or in apoptotic bodies, 
                    or form complexes with RNA binding proteins, such as Argonates (AGOs). 
                    These protected circulating miRNAs remain in remarkably stable forms, 
                    rendering potential cancer biomarkers for non-invasive early detection 
                    or tissue-of-origin localization.",
                    style = "font-size: 120%; text-align: justify;")#,
        #br()
        )
        ),
      ...
      box(
        title = NULL, solidHeader = TRUE, collapsible = FALSE, status = 'success',
        width = 12, # solidHeader=TRUE can remove the top boarder
        column(12,
             ...
             tags$p('CancerMIRNome provides a user-friendly interface and a suite of advanced functions for: 
                    (I) the pan-cancer analysis of a miRNA of interest across multiple cancer types; and 
                    (II) the comprehensive analysis of cancer miRNome profiles to identify boimarkers/signatures for 
                    cancer diagnosis and prognosis.', style = "font-size: 120%; text-align: justify;"),
      ...
      tabsetPanel(id = 'query', #type='pills', #widths = c(2,10), 
                  ...
                  tabPanel(strong('TCGA Project'),
                           ...
                           column(12,
                                  ...
                                  column(4, align='center',
                                         ...
                                         plotOutput('tcga_rocplot',width = 360, height = 350),
                                         br(),
                                         column(7),
                                         column(5,
                  ...
                  tabPanel(strong('Functional Enrcichment'),
                           column(12, 
                                  ...
                                  br(),
                                  div(DT::dataTableOutput("enrichment"), style = "font-size:90%")
                           ),
                  ...
                  tabPanel(strong('Circulating miRNA Expression'),
                           ...
                           #   #title = tags$div(HTML('<b><i class="fa fa-chevron-circle-down" style = "color:black;"></i> Select a TCGA miRNome Dataset</b>')), status = "danger", solidHeader = FALSE, collapsible = FALSE, 
                           #   #title = NULL, status = "danger", solidHeader = TRUE, collapsible = FALSE,
                           #   width = 12,
                           #   
                           ...
                           column(12,
                           br(),
                           #h5(strong('Select a dataset:')),
                           br(),
                           DT::dataTableOutput("browser_datasets"),
                           #circulating.expression.id,
                           hr()
                           ),
...
tab_tcga <- dashboardPage(
  ...
  dashboardBody(fluidRow(
    ...
    box(
      ...
      h4(strong('Comprehensive Analysis & Visualization of TCGA miRNome Profiles'), align='center', style='font-family:Georgia;color:#2C3E50')
    ),
...
tab_circulating <- dashboardPage(
  ...
  dashboardBody(fluidRow(
    ...
    box(
      ...
      h4(strong('Comprehensive Analysis & Visualization of Circulating miRNome Profiles'), align='center', style='font-family:Georgia;color:#2C3E50')
    ),
    
    
    box(
      #title = 'Select a Circulating miRNome Dataset', status = "primary", solidHeader = TRUE, collapsible = FALSE,
      #title = tags$div(HTML('<b><i class="fa fa-chevron-circle-down" style = "color:black;"></i> Select a Circulating miRNome Dataset</b>')), status = "danger", solidHeader = TRUE, collapsible = FALSE,
      title = NULL, status = "danger", solidHeader = TRUE, collapsible = FALSE,
      width = 12, 
      ...
      tabsetPanel(id = 'ccma.tabset',
                  tabPanel(strong("Summary"), 
                           ...
                           box(title = 'Summary',
                               ...
                               textOutput('circulating_text_summary_accession'),
                               br(),
                               strong('Platform:'),
                               textOutput('circulating_text_summary_platform'),
                               br(),
                               strong('Cancer Types:'),
                               textOutput('circulating_text_summary_cancer_type')#,
                               # br(),
                               # strong('Data Preprocessing:'),
                               # textOutput('circulating_text_summary_pipeline')#,
                           ...
                           box(title = 'Disease Status',
                               ...
                               width = 4,
                               height = 375,
                               plotlyOutput('pie_disease_status', width='100%', height='300px')
                           ),
                           ...
                           box(title = 'Subgroups',
                               ...
                               width = 4,
                               height = 375,
                               plotlyOutput('pie_group', width='100%', height='300px')
                           ),
...
tab_download <- dashboardPage(
  ...
  dashboardBody(fluidRow(
    ...
    # box(
    #   title = strong('TCGA miRNome Datasets'), status = "danger", solidHeader = TRUE, collapsible = FALSE,
    #   width = 12,
      
      column(12,
             h5(strong("TCGA miRNome Profiles"), align='left', style='color:black')
      ),
      ...
      column(12,
             tags$hr(style="border-top: 1px dashed #A9A9A9"),
             h5(strong("Circulating miRNome Profiles"), align='left', style='color:black')
      ),
      
      # box(
      #   title = strong('Circulating miRNome Datasets'), status = "danger", solidHeader = TRUE, collapsible = FALSE,
      #   width = 12,
...
tab_tutorial <- dashboardPage(
  ...
  dashboardBody(fluidRow(
    ...
    box(
      ...
      h4(strong('Tutorial for Cancer miRNome Data Analysis & Visualization'), align='center', style='font-family:Georgia;color:#2C3E50')
    ),
      ...
      navlistPanel(id = 'pipeline', widths = c(3, 9),
                   ...
                   tabPanel(strong("Query a miRNA"),
                            ...
                            tags$p("Users can query a miRNA of interest by typing the miRNA accession number, miRNA ID of miRBase release 22.1 [1] or previous miRNA IDs in 
                                   ...
                                   Diana-TarBase [6] are also provided.", style = "font-size: 100%; text-align: justify;"), # ", tags$sup("[1]"), "
                            ...
                            tags$p("Pan-cancer DE analysis and ROC analysis of a miRNA 
                                   ...
                                   in 33 cancer types from TCGA (Figure 2).", style = "font-size: 100%; text-align: justify;"),
                            ...
                            tags$p("(1) Wilcoxon rank sum test is used for DE analysis. 
                                   ...
                                   in a box plot.", style = "font-size: 100%; text-align: justify;"),
                            ...
                            tags$p("CancerMIRNome provides functions to focus the DE analysis, 
                                   ...
                                   interest in a selected TCGA project.", style = "font-size: 100%; text-align: justify;"),
                            ...
                            tags$p("Functional enrichment analysis of the target genes for a miRNA 
                                   ...
                                   pathway/ontology knowledgebases including: ", style = "font-size: 100%; text-align: justify;"),
                            ...
                            tags$p("A data table is produced to summarize the significantly enriched 
                                   ...
                                   are visualized using both bar plot and bubble plot.", style = "font-size: 100%; text-align: justify;"),
                            ...
                            tags$p("[1] Kozomara, A., Birgaoanu, M. and Griffiths-Jones, S. (2019) miRBase: from microRNA sequences to function. Nucleic acids research, 47, D155-D162.", style = "font-size: 80%; text-align: justify;"),
                            tags$p("[2] Li, J.-H., Liu, S., Zhou, H., Qu, L.-H. and Yang, J.-H. (2014) starBase v2. 0: decoding miRNA-ceRNA, miRNA-ncRNA and protein-RNA interaction networks from large-scale CLIP-Seq data. Nucleic acids research, 42, D92-D97.", style = "font-size: 80%; text-align: justify;"),
                            tags$p("[3] Chen, Y. and Wang, X. (2020) miRDB: an online database for prediction of functional microRNA targets. Nucleic acids research, 48, D127-D131.", style = "font-size: 80%; text-align: justify;"),
                            tags$p("[4] Huang, H.-Y., Lin, Y.-C.-D., Li, J., Huang, K.-Y., Shrestha, S., Hong, H.-C., Tang, Y., Chen, Y.-G., Jin, C.-N. and Yu, Y. (2020) miRTarBase 2020: updates to the experimentally validated microRNA-target interaction database. Nucleic acids research, 48, D148-D154.", style = "font-size: 80%; text-align: justify;"),
                            tags$p("[5] Agarwal, V., Bell, G.W., Nam, J.-W. and Bartel, D.P. (2015) Predicting effective microRNA target sites in mammalian mRNAs. elife, 4, e05005.", style = "font-size: 80%; text-align: justify;"),
                            tags$p("[6] Karagkouni, D., Paraskevopoulou, M.D., Chatzopoulos, S., Vlachos, I.S., Tastsoglou, S., Kanellos, I., Papadimitriou, D., Kavakiotis, I., Maniou, S. and Skoufos, G. (2018) DIANA-TarBase v8: a decade-long collection of experimentally supported miRNA-gene interactions. Nucleic acids research, 46, D239-D245.", style = "font-size: 80%; text-align: justify;"),
                            tags$p("[7] Yu, G., Wang, L.-G., Han, Y. and He, Q.-Y. (2012) clusterProfiler: an R package for comparing biological themes among gene clusters. Omics: a journal of integrative biology, 16, 284-287.", style = "font-size: 80%; text-align: justify;")
                   ...
                   tabPanel(strong("TCGA miRNome"),
                            box(
                              ...
                              tags$img(src='img/tcga_overview.jpg', width=800),
                   ...
                   tabPanel(strong("Circulating miRNome"),
                            box(
                              ...
                              tags$img(src='img/circulating_overview.jpg', width=800),
                   ...
                   tabPanel(strong("Data Download"),
                            box(
                              ...
                              h5(strong('1. Download Processed miRNome Datasets'), align='left'),
                              
                              br(),
                              
                              tags$p("All the processed data deposited in CancerMIRNome, including the ", 
                                     style = "font-size: 100%;display:inline; text-align: justify;"),
                              tags$i(strong("ExpresionSet"), style = "font-size: 100%;display:inline; text-align: justify;"),
                              ...
                              h6(strong('Figure 1. Download processed miRNA expression data, sample metadata, and miRNA annotation data'), align='center'),
                              
                              br(),
                              
                              h5(strong('2. Export Data Analysis & Visualization Results'), align='left'),
                              
                              br(),
                              
                              tags$p("We provide two download buttons (",
                                     style = "font-size: 100%;display:inline"),
                              tags$i(strong("PDF"), style = "font-size: 100%;display:inline"),
                              tags$p(" and ",
                                     style = "font-size: 100%;display:inline"),
                              tags$i(strong("CSV"), style = "font-size: 100%;display:inline"),
                              
                              tags$p(") under each figure generated by CancerMIRNome, allowing the users to 
                              ...
                              tags$img(src='img/download_pdf.jpg', width=800),
                              
                              h6(strong('Figure 2. Download the publication-quality vector image in PDF format'), align='center'),
                              
                              br(),
                              
                              tags$p("In this example, the expression data of the selected miRNA ", 
                                     style = "font-size: 100%;display:inline"),
                              
                              tags$i(strong("hsa-let-7a-5p"), style = "font-size: 100%;display:inline"),
                              
                              tags$p(" for all the samples across the 33 TCGA projects will be saved to the 
                                     CSV file ", 
                                     style = "font-size: 100%;display:inline"),
                              
                              tags$i(strong("hsa-let-7a-5p.TCGA_PanCancer_Expression_Data.csv"), 
                                     style = "font-size: 100%;display:inline"),
                              
                              tags$i(strong(". by clicking the download button."), style = "font-size: 100%;display:inline"),
                              
                              tags$img(src='img/download_csv.jpg', width=800),
                              
                              h6(strong('Figure 2. Download the data that is used to generate the figure to a CSV file'), align='center'),
                              ...
                              tags$p(" or ",
                                     style = "font-size: 100%;display:inline"),
                              tags$i(strong("EXCEL"), style = "font-size: 100%;display:inline"),
                              
                              tags$p(" formats. The output can also be copied to the clipboard.",
                                     style = "font-size: 100%;display:inline"),
                              
                              tags$img(src='img/download_table.jpg', width=800),
                              
                              h6(strong('Figure 3. Download the data table for the data analysis output'), align='center')
