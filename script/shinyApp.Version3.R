...
tab_home <- dashboardPage(
  ...
  dashboardBody(fluidRow(
    box(
      ...
      column(12,
             h3(strong('The Cancer Genome Atlas (TCGA) miRNomes')),
      ...
      column(12,
             h3(strong('Cancer Circulating miRNomes')),
             
             valueBox(value = tags$p(strong("30"), style = "font-size: 90%;"), color = 'teal', width = 3,
                      subtitle = tags$p(strong("Cancer types"), style = "font-size: 160%;"),  icon = icon("dna")),
             valueBox(value = tags$p(strong("42"), style = "font-size: 90%;"), color = 'teal', width = 3,
          ...
          tabPanel(strong("Differential miRNA"), 
                   ...
                   column(12,
                          column(6,
                                 ...
                                 # conditionalPanel(condition="input.tcga_metadata!='preop_psa'",# && input$tcga_metadata!='age_at_initial_pathologic_diagnosis'",
                                 #                  DT::dataTableOutput("groups.tcga.diy")
                                 # )
...
ui <- fluidPage(
  div(img(src = "miRNomes_logo4.png")),
